...
let cart = [];
let products = [
    { id: 'kopi-o', name: 'Kopi-O Special', price: 3.50, desc: 'Our signature strong black coffee.', imgUrl:'https://github.com/xGroup10x/Kopi-jalanan/blob/main/kopiO.jpg?raw=true'},
